...
import {
    CheckSquare, Plus, Loader2, Check, X, Clock, AlertTriangle, Calendar,
} from 'lucide-react'
import {
...
export default function TasksClient() {
    ...
    const [form, setForm] = useState({
        ...
        assignedToId: '', contactId: '', description: '',
    })
    ...
    async function handleCreate() {
        ...
        try {
            ...
            setShowModal(false)
            setForm({ title: '', type: 'Follow-up', priority: 'Medium', dueDate: '', assignedToId: '', contactId: '', description: '' })
            await load()
        } finally {
            setSaving(false)
        }
