    ...
    <div className="fixed inset-0 flex flex-col bg-surface">
      ...
      <header className="flex flex-shrink-0 items-center gap-2 border-b border-border bg-surface px-3 py-3 sm:gap-3 sm:px-4">
        <button
          ...
          className="flex h-9 w-9 flex-shrink-0 items-center justify-center rounded-md text-muted transition-colors hover:bg-surface-light hover:text-foreground"
        ...
        <input
          ...
          className="min-w-0 flex-1 rounded-md bg-transparent px-2 py-1 text-sm font-semibold text-foreground placeholder:text-muted focus:bg-surface-light focus:outline-none sm:text-base"
        />
...
function TriggerCard({
  ...
  return (
    ...
    <div className="z-10 w-full max-w-[320px] sm:w-80">
      <div className="rounded-lg border border-border border-l-4 border-l-blue-500 bg-surface shadow-lg">
        <button
          type="button"
          onClick={() => setOpen((v) => !v)}
          ...
          <div className="space-y-3 border-t border-border px-4 py-3">
            <div>
              ...
              <select
                ...
                className="w-full rounded-md border border-border bg-surface-light px-2 py-1.5 text-sm text-foreground focus:border-accent focus:outline-none"
              >
            ...
            {type === "tag_added" && (
              <Input
                ...
                className="bg-surface-light text-foreground"
              />
            )}
            {type === "time_based" && (
              <Input
    ...
    <div className="space-y-2">
      ...
      <div>
        ...
        <select
          ...
          className="w-full rounded-md border border-border bg-surface-light px-2 py-1.5 text-sm text-foreground focus:outline-none"
        >
  ...
  return (
    <>
      <div className={cn("z-10 flex flex-col", width)}>
        <div
          className={cn(
            "rounded-lg border border-border border-l-4 bg-surface shadow-lg",
            meta.border,
          )}
        >
          <button
            ...
            className="flex w-full items-center gap-3 px-4 py-3 text-left"
          >
            <GripVertical className="h-4 w-4 flex-shrink-0 text-muted" aria-hidden />
            <div className="flex h-8 w-8 items-center justify-center rounded-md bg-surface-light text-foreground">
            ...
            <div className="min-w-0 flex-1">
              ...
              <div className="truncate text-[11px] text-muted">{previewFor(step)}</div>
            </div>
            <ChevronDown
...
function ConditionBranches({
  ...
  return (
    ...
    <div className="mt-3 grid grid-cols-1 gap-3 sm:grid-cols-2">
      <BranchColumn label="Yes" color="text-accent">
  ...
  return (
    <div className="relative flex flex-col items-center">
      ...
      <DropdownMenu>
        ...
        <DropdownMenuContent
          align="start"
          className="max-h-80 min-w-56 overflow-y-auto border-border bg-surface"
        >
          {ADDABLE_STEPS.map((t) => {
      ...
      return (
        <FieldBlock label="Message text">
          <Textarea
            ...
            className="min-h-24 bg-surface-light text-foreground"
          />
        </FieldBlock>
      )
    case "send_template":
        ...
        <>
          <FieldBlock label="Mode">
            <select
              ...
              className="w-full rounded-md border border-border bg-surface-light px-2 py-1.5 text-sm text-foreground"
            >
        ...
        <>
          ...
          <FieldBlock label="Body template (JSON)">
            <Textarea
              ...
              className="min-h-20 bg-surface-light font-mono text-xs text-foreground"
            />
          </FieldBlock>
        </>
      )
